...
TreeNode* buildTree()
{
    ...
    cout<<"\nenter left child for node:"<<x<<endl;
    temp->left=buildTree();
    cout<<"\nenter right child for node:"<<x<<endl;
...
int main() {
   ...
   cout<<"\n countallnodes in tree: "<<countallnodes(root);
   cout<<"\n countleafnodes in tree: "<<countleafnodes(root);
   cout<<"\n countnonleafnodes in tree: "<<countnonleafnodes(root);
   cout<<"\n sumofallnodes in tree: "<<sumofallnodes(root);
   cout<<"\n sumleafnodes in tree: "<<sumleafnodes(root);
   cout<<"\n sumnonleafnodes in tree: "<<sumnonleafnodes(root);
   cout<<"\n height of tree: "<<heightoftree(root);
   cout<<"\n diameter of tree: "<<diamteroftree(root);
   return 0;
}